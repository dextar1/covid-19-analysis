# Group members
# Usman Ahmad - 218203149
# Fidan Badalova - 218203384
# Hammad Akhtar - 218203381
# Waseem Abbas - 218101041
# Waseem Ahmed - 218203457
...
def main():
    ...
    featureassembler = VectorAssembler(
        inputCols=["index_double"], outputCol="new_index")
    ...
    regressor = LinearRegression(
        featuresCol='new_index', labelCol='Infections')
    ...
    # visualize results
    ####################################
    actual_values = pred_results.predictions.select(
        'new_index', 'Infections').collect()
    predicted_values = pred_results.predictions.select(
        'new_index', 'prediction').collect()
